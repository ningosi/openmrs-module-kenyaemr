...
public class HivMetadata extends AbstractMetadataBundle {
	...
	public static final class _EncounterType {
		...
		public static final String DRUG_ORDER = "fe171834-7641-11e4-bc18-5bf35ffd28a5";
	}
	...
	public static final class _Form {
		...
		public static final String DRUG_ORDER = "1aa7c390-7642-11e4-a9cf-fbb97fdc02c0";
	}
	...
	public void install() {
		...
		install(encounterType("Drug Order", "For administering drugs to patients", _EncounterType.DRUG_ORDER));
		...
		install(form("Drug Order", null, _EncounterType.DRUG_ORDER, "1", _Form.DRUG_ORDER));
